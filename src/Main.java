...
public class Main {
    public static void main(String[] args) {
        ...
        listUser.add(new NodeUser(1, "abi","user1", "user1@gmail.com"));
        listUser.add(new NodeUser(2, "aba","user2", "user2@gmail.com"));
        ...
        users.add(new NodeUser(4, "adi", "user4", "user4@gmail.com"));
        System.out.print("\nTambah user ID 4: ");
